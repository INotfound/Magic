...
WorkspacePath          :=D:/Source/Magic
ProjectPath            :=D:/Source/Magic/Server
...
$(IntermediateDirectory)/Src_Log_logFormatter.cc$(ObjectSuffix): Src/Log/logFormatter.cc $(IntermediateDirectory)/Src_Log_logFormatter.cc$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/Source/Magic/Server/Src/Log/logFormatter.cc" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Src_Log_logFormatter.cc$(ObjectSuffix) $(IncludePath)
