...
public:
    ...
    void handle1(const Safe<Magic::NetWork::Http::HttpSocket>& httpSocket){
        ...
        auto httpClient = std::make_shared<Magic::NetWork::Http::HttpClient>("http://www.baidu.com/",1000);
        httpClient->onResponse([httpSocket,response](const Safe<Magic::NetWork::Http::HttpResponse>& httpResponse){
