 ...
 * @LastEditTime: 2020-12-17 13:36:09
 */
#pragma once
#include <map>
#include <vector>
...
#define MAGIC_INFO()         MAGIC_LOG_LEVEL(g_Logger,Magic::LogLevel::Info)
#define MAGIC_WARN()         MAGIC_LOG_LEVEL(g_Logger,Magic::LogLevel::Warn)
#define MAGIC_DEBUG()        MAGIC_LOG_LEVEL(g_Logger,Magic::LogLevel::Debug)
#define MAGIC_ERROR()        MAGIC_LOG_LEVEL(g_Logger,Magic::LogLevel::Error)
#define MAGIC_FATAL()        MAGIC_LOG_LEVEL(g_Logger,Magic::LogLevel::Fatal)